...
- [Rust核心深入](rust_cores.md)
    ...
    - [II. 类型系统](2_type_system.md)
        ...
        - [泛型](2_2_generic.md)
            - [泛型就像函数](2_2_1_generic_basic.md)
            - [泛型数据结构](2_2_2_generic_data_structure.md)
            - [泛型参数](2_2_3_generic_args.md)
            - [泛型函数](2_2_4_generic_fn.md)
        - [trait](2_3_trait.md)
            - [trait概览](2_3_0_trait_overview.md)
            - [Trait Impl](2_3_1_trait_impl.md)
            - [Trait Object](2_3_2_trait_object.md)
            - [常用trait](2_3_3_trait_frequently.md)
            - [Trait设计](2_3_4_trait_design.md)
