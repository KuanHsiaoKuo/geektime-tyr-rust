...
- [Rust核心深入](rust_cores.md)
    ...
    - [II. 类型系统](2_type_system.md)
        ...
        - [三种多态形式](2_4_0_three_polymorphics.md)
            - [参数多态-Generics: <>](2_4_1_generic_usage.md)
            - [特设多态-Trait impl/bound: self](2_4_2_trait_impl.md)
            - [子类型多态Trait object: &self](2_4_3_trait_object.md)
...
- [Rust高级话题](rust_advanced_topics.md)
    ...
    - [III. 混合编程](6_unsafe_ffi.md)
    - [IV. 网络开发](7_network.md)
