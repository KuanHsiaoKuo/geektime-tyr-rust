...
~~~admonish question title="衍生出哪些工作模式？它们的核心是什么？" collapsible=true
...
~~~admonish info title="互斥锁解决独占问题" collapsible=true
...
~~~admonish info title="但互斥锁不能解决顺序同步问题" collapsible=true
...
~~~admonish info title="使用Atomic+CAS确保原子操作顺序" collapsible=true
最基础的保证是：CAS
